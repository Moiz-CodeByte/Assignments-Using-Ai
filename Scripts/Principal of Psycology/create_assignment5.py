...
# Color scheme - teal instead of navy
TEAL = RGBColor(0x00, 0x6B, 0x7F)
...
# ── TITLE PAGE ────────────────────────────────────────────────────────────────
doc.add_paragraph()
h("How to Help Employees Achieve Work-Life Balance", size=20, center=True, space_before=0)
doc.add_paragraph()
h("Assignment — Professional Practices in Management", size=11, center=True, space_before=2)
doc.add_paragraph()
...
for i, (l, v) in enumerate(info):
    ...
    lp = lc.paragraphs[0]
    lr = lp.add_run(l)
    lr.bold = True; lr.font.name = "Calibri"; lr.font.size = Pt(10.5)
    vp = vc.paragraphs[0]
    vr = vp.add_run(v)
...
# ── INTRODUCTION ──────────────────────────────────────────────────────────────
h("Introduction", underline=True, space_before=6)
body(
...
# ── STRATEGIES ────────────────────────────────────────────────────────────────
h("Key Strategies for Achieving Work-Life Balance", underline=True, space_before=8)
...
for title, text in strategies:
    h(title, size=11, underline=False, space_before=6)
    body(text)

# ── BENEFITS ──────────────────────────────────────────────────────────────────
h("Benefits of Work-Life Balance", underline=True, space_before=8)
...
# ── CHALLENGES ────────────────────────────────────────────────────────────────
h("Common Challenges", underline=True, space_before=8)
challenges = [
...
# ── CONCLUSION ────────────────────────────────────────────────────────────────
h("Conclusion", underline=True, space_before=8)
body(
...
# ── REFERENCES ────────────────────────────────────────────────────────────────
h("References", underline=True, space_before=8)
refs = [
...
out = r"t:\Abdul\Assignments Using ai\Word Files\Work_Life_Balance_Assignment_v5.docx"
doc.save(out)
print(f"Saved: {out}")
